...
#    visualize.visualize(seg, title="Raw from WAV file")
    ...
    _seg16_m_32 = seg.resample(sample_rate_Hz=16000, sample_width=4, channels=1)
    _seg24_m_24 = seg.resample(sample_rate_Hz=24000, sample_width=3, channels=1)
    _seg16_m_16 = seg.resample(sample_rate_Hz=16000, sample_width=2, channels=1)
    _seg32_8_16 = seg.resample(sample_rate_Hz=32000, sample_width=2, channels=2)
    _seg32_8_16 = seg.resample(sample_rate_Hz=32000, sample_width=2, channels=8)
